...
const colorMap = {
  ...
  indigo: {
    link: 'hover:border-indigo-500',
    circle: 'bg-indigo-50',
    iconBg: 'bg-indigo-50 p-4 text-indigo-600 group-hover:bg-indigo-600',
    actionLabel: 'text-indigo-600',
  },
}
    ...
    >
      ...
      <div className="relative z-10 space-y-6">
        ...
        >
          ...
          <LucideArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-2" />
        </div>
      </div>
    </Link>
  )
